...
export default function GameFlowDesigner() {
  ...
  const [activeTab, setActiveTab] = useState<
    "details" | "validation" | "save" | "undo" | "computation" | "ai"
  >("details");
  ...
  return (
    <div className="flex h-full w-full bg-gray-50">
      {/* Side Panel */}
      <div className="w-[500px] bg-white shadow-lg border-r border-gray-200 flex flex-col">
        {/* Header */}
