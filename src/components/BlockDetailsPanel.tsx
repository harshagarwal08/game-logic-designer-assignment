    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          max="1000"
          className="input-field"
          value={properties.startingHealth || ''}
          onChange={(e) => handlePropertyChange('startingHealth', parseInt(e.target.value) || 0)}
          placeholder="100"
        />
      </div>
      <div>
        ...
        <input
          ...
          max="10000"
          className="input-field"
          value={properties.startingGold || ''}
          onChange={(e) => handlePropertyChange('startingGold', parseInt(e.target.value) || 0)}
          placeholder="0"
        />
      </div>
      <div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            onChange={(e) => handlePropertyChange('health', parseInt(e.target.value) || 0)}
            placeholder="50"
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => handlePropertyChange('attack', parseInt(e.target.value) || 0)}
            placeholder="10"
          />
        </div>
      </div>
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input
            ...
            max="1000"
            className="input-field"
            value={properties.goldReward || ''}
            onChange={(e) => handlePropertyChange('goldReward', parseInt(e.target.value) || 0)}
            placeholder="25"
          />
        </div>
      </div>
      <div>
        ...
        <input
          ...
          onChange={(e) => handlePropertyChange('experiencePoints', parseInt(e.target.value) || 0)}
          placeholder="15"
        />
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          max="10000"
          className="input-field"
          value={properties.finalScore || ''}
          onChange={(e) => handlePropertyChange('finalScore', parseInt(e.target.value) || 0)}
          placeholder="0"
        />
      </div>
      <div>
    ...
    <div className="space-y-6">
      ...
      <div className="card bg-green-50 border-green-200">
        ...
        <div className="text-xs text-green-600">
          All properties are editable! Changes will be reflected in the canvas and saved automatically.
        </div>
      </div>
    </div>
  )
